<template>
  <ul class="breadcrumbs">
    ...
    <li class="breadcrumbs__item">
      <router-link :to="{ name: 'adminArticles' }" class="breadcrumbs__link">
        Статьи
      </router-link>
    </li>
    <li class="breadcrumbs__item">
      <span class="breadcrumbs__link" disabled> Редактирование статьи </span>
    </li>
  </ul>
...
export default defineComponent({
  ...
  setup() {
    ...
    return changeArticle('article', route.params.id)
  }
})
</script>
