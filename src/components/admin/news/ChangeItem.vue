<template>
  <ul class="breadcrumbs">
    ...
    <li class="breadcrumbs__item">
      <router-link :to="{ name: 'adminNews' }" class="breadcrumbs__link">
        Новости
      </router-link>
    </li>
    <li class="breadcrumbs__item">
      <span class="breadcrumbs__link" disabled> Редактирование новости </span>
    </li>
  </ul>
...
export default defineComponent({
  ...
  setup() {
    ...
    return changeArticle('new', route.params.id)
  }
})
</script>
